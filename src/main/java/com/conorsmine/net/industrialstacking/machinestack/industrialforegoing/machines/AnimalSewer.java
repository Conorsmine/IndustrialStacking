...
public class AnimalSewer extends MachineStack implements Powerable {

    public AnimalSewer(@NotNull IndustrialStacking plugin, @NotNull Block tileEntity) {
        super(plugin, tileEntity, StackableMachines.ANIMAL_SEWER);
    }
